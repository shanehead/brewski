...
<div class="grid grid-cols-2 gap-4 max-w-2xl">
  <div class="flex flex-col gap-1">
    <label for="overview-type" class="text-sm font-medium" style="color: var(--color-text-secondary);">Recipe Type</label>
  ...
  <div class="flex flex-col gap-1">
    <label for="overview-brewer" class="text-sm font-medium" style="color: var(--color-text-secondary);">Brewer</label>
  ...
  <div class="flex flex-col gap-1">
    <label for="overview-equipment" class="text-sm font-medium" style="color: var(--color-text-secondary);">Equipment Profile</label>
  ...
  <div class="flex flex-col gap-1">
    <label for="overview-style" class="text-sm font-medium" style="color: var(--color-text-secondary);">Style</label>
  ...
  <div class="flex flex-col gap-1">
    <label for="overview-date" class="text-sm font-medium" style="color: var(--color-text-secondary);">Date</label>
