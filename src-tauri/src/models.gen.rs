...
impl BatchSummary {
    pub fn builder() -> builder::BatchSummary {
        Default::default()
    }
}
...
impl CreateGravityReadingInput {
    pub fn builder() -> builder::CreateGravityReadingInput {
        Default::default()
    }
}
...
pub struct EquipmentProfile {
    ...
    #[doc = "Volume that remains in the HLT and cannot be transferred, in litres"]
    #[serde(default = "defaults::equipment_profile_hlt_deadspace_l")]
    pub hlt_deadspace_l: f64,
    #[doc = "Minimum HLT water volume in litres"]
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub hlt_water_limit_min_l: ::std::option::Option<f64>,
    ...
    pub notes: ::std::option::Option<::std::string::String>,
    #[doc = "Where to redirect overflow when mash volume limits are exceeded. Enum: 'mash' | 'sparge' | 'hlt'"]
    pub overflow_target: ::std::string::String,
    #[doc = "Ambient room temperature for strike water calculation, in Fahrenheit"]
    pub room_temp_f: f64,
    #[doc = "Mash/sparge water calculation method. Enum: 'no_sparge' | 'batch_sparge' | 'fly_sparge'"]
    ...
    #[doc = "Time wort sits in the whirlpool before chilling, in minutes"]
    #[serde(default = "defaults::equipment_profile_whirlpool_time_min")]
    pub whirlpool_time_min: f64,
}
...
impl GravityReading {
    pub fn builder() -> builder::GravityReading {
        Default::default()
    }
}
...
pub struct Recipe {
    ...
    #[serde(default = "defaults::recipe_hopstand_temp_c")]
    pub hopstand_temp_c: f64,
...
impl RecipeVersionSummary {
    pub fn builder() -> builder::RecipeVersionSummary {
        Default::default()
    }
}
...
impl ::std::default::Default for UpdateBatchInput {
    fn default() -> Self {
        Self {
            actual_batch_size_l: Default::default(),
            actual_fg: Default::default(),
            actual_og: Default::default(),
            actual_post_boil_volume_l: Default::default(),
...
impl UpdateBatchInput {
    pub fn builder() -> builder::UpdateBatchInput {
        Default::default()
    }
}
...
impl ::std::default::Default for UpdateEquipmentProfileInput {
    fn default() -> Self {
        Self {
            ...
            evap_rate_l_hr: Default::default(),
            fermenter_loss_l: Default::default(),
            grain_absorption_rate_l_per_kg: Default::default(),
            grain_temp_f: Default::default(),
            hlt_deadspace_l: Default::default(),
            hlt_water_limit_min_l: Default::default(),
            ...
            name: Default::default(),
            notes: Default::default(),
            overflow_target: Default::default(),
            room_temp_f: Default::default(),
            sparge_method: Default::default(),
            sparge_temp_f: Default::default(),
            sparge_volume_max_l: Default::default(),
            sparge_volume_min_l: Default::default(),
            trub_chiller_loss_l: Default::default(),
            tun_heat_capacity_l: Default::default(),
            water_grain_ratio_l_per_kg: Default::default(),
...
pub mod builder {
    ...
    pub struct Batch {
        ...
        actual_fg: ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
        actual_og: ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
    ...
    impl ::std::default::Default for Batch {
        fn default() -> Self {
            Self {
                actual_batch_size_l: Ok(Default::default()),
                actual_fg: Ok(Default::default()),
                actual_og: Ok(Default::default()),
                actual_post_boil_volume_l: Ok(Default::default()),
    ...
    impl Batch {
        pub fn actual_batch_size_l<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.actual_batch_size_l = value.try_into().map_err(|e| {
                format!("error converting supplied value for actual_batch_size_l: {e}")
            });
            self
        }
        pub fn actual_fg<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.actual_fg = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for actual_fg: {e}"));
            self
        }
        pub fn actual_og<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.actual_og = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for actual_og: {e}"));
            self
        }
        pub fn actual_post_boil_volume_l<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.actual_post_boil_volume_l = value.try_into().map_err(|e| {
                format!("error converting supplied value for actual_post_boil_volume_l: {e}")
            });
            self
        }
        pub fn actual_pre_boil_gravity<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.actual_pre_boil_gravity = value.try_into().map_err(|e| {
                format!("error converting supplied value for actual_pre_boil_gravity: {e}")
            });
            self
        }
        pub fn actual_pre_boil_volume_l<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.actual_pre_boil_volume_l = value.try_into().map_err(|e| {
                format!("error converting supplied value for actual_pre_boil_volume_l: {e}")
            });
            self
        }
        pub fn brew_date<T>(mut self, value: T) -> Self
        where
        ...
        where
            ...
            T::Error: ::std::fmt::Display,
        {
            self.fermenter_date = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for fermenter_date: {e}"));
            self
        }
        pub fn gravity_readings<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::GravityReading>>,
            T::Error: ::std::fmt::Display,
        {
            self.gravity_readings = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for gravity_readings: {e}"));
            self
        }
        ...
        pub fn recipe_name<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::string::String>,
            T::Error: ::std::fmt::Display,
        {
            self.recipe_name = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for recipe_name: {e}"));
            self
        }
        pub fn recipe_version_id<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::string::String>,
            T::Error: ::std::fmt::Display,
        {
            self.recipe_version_id = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<Batch> for super::Batch {
        type Error = super::error::ConversionError;
        fn try_from(value: Batch) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                actual_batch_size_l: value.actual_batch_size_l?,
                actual_fg: value.actual_fg?,
                actual_og: value.actual_og?,
                actual_post_boil_volume_l: value.actual_post_boil_volume_l?,
    ...
    impl ::std::convert::From<super::Batch> for Batch {
        fn from(value: super::Batch) -> Self {
            Self {
                actual_batch_size_l: Ok(value.actual_batch_size_l),
                actual_fg: Ok(value.actual_fg),
                actual_og: Ok(value.actual_og),
                actual_post_boil_volume_l: Ok(value.actual_post_boil_volume_l),
    ...
    impl ::std::default::Default for BatchSummary {
        fn default() -> Self {
            Self {
                actual_fg: Ok(Default::default()),
                actual_og: Ok(Default::default()),
    ...
    impl ::std::convert::TryFrom<BatchSummary> for super::BatchSummary {
        type Error = super::error::ConversionError;
        fn try_from(
            value: BatchSummary,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::BatchSummary> for BatchSummary {
        fn from(value: super::BatchSummary) -> Self {
            Self {
                actual_fg: Ok(value.actual_fg),
                actual_og: Ok(value.actual_og),
                brew_date: Ok(value.brew_date),
    ...
    impl ::std::convert::From<super::CreateBatchInput> for CreateBatchInput {
        fn from(value: super::CreateBatchInput) -> Self {
            Self {
                name: Ok(value.name),
                recipe_id: Ok(value.recipe_id),
    ...
    pub struct CreateEquipmentProfileInput {
        ...
        evap_rate_l_hr: ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
        ...
        notes: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        overflow_target: ::std::result::Result<
            ::std::option::Option<::std::string::String>,
            ::std::string::String,
        >,
        room_temp_f: ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
        sparge_method: ::std::result::Result<
            ::std::option::Option<::std::string::String>,
            ::std::string::String,
        >,
        sparge_temp_f: ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
        sparge_volume_max_l:
            ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
        sparge_volume_min_l:
            ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
    ...
    impl ::std::default::Default for CreateEquipmentProfileInput {
        fn default() -> Self {
            Self {
                ...
                evap_rate_l_hr: Ok(Default::default()),
                ...
                notes: Ok(Default::default()),
                overflow_target: Ok(Default::default()),
                room_temp_f: Ok(Default::default()),
                sparge_method: Ok(Default::default()),
                sparge_temp_f: Ok(Default::default()),
    ...
    impl CreateEquipmentProfileInput {
        ...
        pub fn evap_rate_l_hr<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.evap_rate_l_hr = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for evap_rate_l_hr: {e}"));
            self
        }
        ...
        pub fn grain_absorption_rate_l_per_kg<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.grain_absorption_rate_l_per_kg = value.try_into().map_err(|e| {
                format!("error converting supplied value for grain_absorption_rate_l_per_kg: {e}")
            });
            self
        }
        pub fn grain_temp_f<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.grain_temp_f = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for grain_temp_f: {e}"));
            self
        }
        ...
        pub fn hlt_water_limit_min_l<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.hlt_water_limit_min_l = value.try_into().map_err(|e| {
                format!("error converting supplied value for hlt_water_limit_min_l: {e}")
            });
            self
        }
        pub fn hopstand_temp_f<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.hopstand_temp_f = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for hopstand_temp_f: {e}"));
            self
        }
        pub fn include_grain_volume_in_mash_limits<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<bool>>,
            T::Error: ::std::fmt::Display,
        {
            self.include_grain_volume_in_mash_limits = value.try_into().map_err(|e| {
                format!(
                    "error converting supplied value for include_grain_volume_in_mash_limits: {e}"
                )
            });
            self
        }
        ...
        pub fn overflow_target<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<::std::string::String>>,
            T::Error: ::std::fmt::Display,
        {
            self.overflow_target = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for overflow_target: {e}"));
            self
        }
        pub fn room_temp_f<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.room_temp_f = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for room_temp_f: {e}"));
            self
        }
        ...
        pub fn sparge_temp_f<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.sparge_temp_f = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for sparge_temp_f: {e}"));
            self
        }
        ...
        pub fn tun_heat_capacity_l<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.tun_heat_capacity_l = value.try_into().map_err(|e| {
                format!("error converting supplied value for tun_heat_capacity_l: {e}")
            });
            self
        }
        pub fn water_grain_ratio_l_per_kg<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.water_grain_ratio_l_per_kg = value.try_into().map_err(|e| {
                format!("error converting supplied value for water_grain_ratio_l_per_kg: {e}")
            });
            self
        }
    ...
    impl ::std::convert::TryFrom<CreateEquipmentProfileInput> for super::CreateEquipmentProfileInput {
        ...
        fn try_from(
            ...
            Ok(Self {
                ...
                evap_rate_l_hr: value.evap_rate_l_hr?,
                fermenter_loss_l: value.fermenter_loss_l?,
                grain_absorption_rate_l_per_kg: value.grain_absorption_rate_l_per_kg?,
                grain_temp_f: value.grain_temp_f?,
                hlt_deadspace_l: value.hlt_deadspace_l?,
                hlt_water_limit_min_l: value.hlt_water_limit_min_l?,
                ...
                name: value.name?,
                notes: value.notes?,
                overflow_target: value.overflow_target?,
                room_temp_f: value.room_temp_f?,
                sparge_method: value.sparge_method?,
                sparge_temp_f: value.sparge_temp_f?,
    ...
    impl ::std::convert::From<super::CreateEquipmentProfileInput> for CreateEquipmentProfileInput {
        fn from(value: super::CreateEquipmentProfileInput) -> Self {
            Self {
                ...
                evap_rate_l_hr: Ok(value.evap_rate_l_hr),
                fermenter_loss_l: Ok(value.fermenter_loss_l),
                grain_absorption_rate_l_per_kg: Ok(value.grain_absorption_rate_l_per_kg),
                grain_temp_f: Ok(value.grain_temp_f),
                hlt_deadspace_l: Ok(value.hlt_deadspace_l),
                hlt_water_limit_min_l: Ok(value.hlt_water_limit_min_l),
                ...
                name: Ok(value.name),
                notes: Ok(value.notes),
                overflow_target: Ok(value.overflow_target),
                room_temp_f: Ok(value.room_temp_f),
                sparge_method: Ok(value.sparge_method),
                sparge_temp_f: Ok(value.sparge_temp_f),
    ...
    pub struct CreateGravityReadingInput {
        ...
        notes: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        recorded_at: ::std::result::Result<i64, ::std::string::String>,
        temp_c: ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
    }
    impl ::std::default::Default for CreateGravityReadingInput {
        fn default() -> Self {
            Self {
                gravity: Err("no value supplied for gravity".to_string()),
                notes: Ok(Default::default()),
                recorded_at: Err("no value supplied for recorded_at".to_string()),
                temp_c: Ok(Default::default()),
            }
        }
    }
    impl CreateGravityReadingInput {
        pub fn gravity<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<f64>,
            T::Error: ::std::fmt::Display,
        {
            self.gravity = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for gravity: {e}"));
            self
        }
        pub fn notes<T>(mut self, value: T) -> Self
        where
        ...
        pub fn temp_c<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<f64>>,
            T::Error: ::std::fmt::Display,
        {
            self.temp_c = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for temp_c: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<CreateGravityReadingInput> for super::CreateGravityReadingInput {
        type Error = super::error::ConversionError;
        fn try_from(
            value: CreateGravityReadingInput,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
    ...
    impl ::std::convert::From<super::CreateGravityReadingInput> for CreateGravityReadingInput {
        fn from(value: super::CreateGravityReadingInput) -> Self {
            Self {
                gravity: Ok(value.gravity),
                notes: Ok(value.notes),
                recorded_at: Ok(value.recorded_at),
                temp_c: Ok(value.temp_c),
            }
        }
    }
    #[derive(Clone, Debug)]
    ...
    pub struct EquipmentProfile {
        ...
        created_at: ::std::result::Result<i64, ::std::string::String>,
        efficiency_pct: ::std::result::Result<f64, ::std::string::String>,
        evap_rate_l_hr: ::std::result::Result<f64, ::std::string::String>,
        fermenter_loss_l: ::std::result::Result<f64, ::std::string::String>,
        grain_absorption_rate_l_per_kg: ::std::result::Result<f64, ::std::string::String>,
        grain_temp_f: ::std::result::Result<f64, ::std::string::String>,
        hlt_deadspace_l: ::std::result::Result<f64, ::std::string::String>,
        hlt_water_limit_min_l:
            ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
        ...
        notes: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        overflow_target: ::std::result::Result<::std::string::String, ::std::string::String>,
        room_temp_f: ::std::result::Result<f64, ::std::string::String>,
    ...
    impl ::std::default::Default for EquipmentProfile {
        fn default() -> Self {
            Self {
                ...
                created_at: Err("no value supplied for created_at".to_string()),
                efficiency_pct: Err("no value supplied for efficiency_pct".to_string()),
                evap_rate_l_hr: Err("no value supplied for evap_rate_l_hr".to_string()),
                fermenter_loss_l: Err("no value supplied for fermenter_loss_l".to_string()),
                grain_absorption_rate_l_per_kg: Err(
                    "no value supplied for grain_absorption_rate_l_per_kg".to_string(),
                ),
                grain_temp_f: Err("no value supplied for grain_temp_f".to_string()),
                hlt_deadspace_l: Ok(super::defaults::equipment_profile_hlt_deadspace_l()),
                hlt_water_limit_min_l: Ok(Default::default()),
                hop_utilization_pct: Err("no value supplied for hop_utilization_pct".to_string()),
                hopstand_temp_f: Err("no value supplied for hopstand_temp_f".to_string()),
                id: Err("no value supplied for id".to_string()),
                ...
                name: Err("no value supplied for name".to_string()),
                notes: Ok(Default::default()),
                overflow_target: Err("no value supplied for overflow_target".to_string()),
                room_temp_f: Err("no value supplied for room_temp_f".to_string()),
                ...
                whirlpool_time_min: Ok(super::defaults::equipment_profile_whirlpool_time_min()),
            }
        }
    }
    impl EquipmentProfile {
    ...
    impl ::std::default::Default for GravityReading {
        fn default() -> Self {
            Self {
                batch_id: Err("no value supplied for batch_id".to_string()),
                gravity: Err("no value supplied for gravity".to_string()),
    ...
    impl ::std::convert::TryFrom<GravityReading> for super::GravityReading {
        type Error = super::error::ConversionError;
        fn try_from(
            value: GravityReading,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                batch_id: value.batch_id?,
                gravity: value.gravity?,
    ...
    impl ::std::convert::From<super::GravityReading> for GravityReading {
        fn from(value: super::GravityReading) -> Self {
            Self {
                batch_id: Ok(value.batch_id),
                gravity: Ok(value.gravity),
                id: Ok(value.id),
    ...
    impl ::std::default::Default for Recipe {
        fn default() -> Self {
            Self {
                ...
                hopstand_temp_c: Ok(super::defaults::recipe_hopstand_temp_c()),
                id: Err("no value supplied for id".to_string()),
    ...
    impl ::std::default::Default for RecipeVersionSummary {
        fn default() -> Self {
            Self {
                created_at: Err("no value supplied for created_at".to_string()),
                id: Err("no value supplied for id".to_string()),
    ...
    impl RecipeVersionSummary {
        ...
        pub fn version_number<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<i64>,
            T::Error: ::std::fmt::Display,
        {
            self.version_number = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for version_number: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<RecipeVersionSummary> for super::RecipeVersionSummary {
        type Error = super::error::ConversionError;
        fn try_from(
            value: RecipeVersionSummary,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                created_at: value.created_at?,
                id: value.id?,
    ...
    impl ::std::convert::From<super::RecipeVersionSummary> for RecipeVersionSummary {
        fn from(value: super::RecipeVersionSummary) -> Self {
            Self {
                created_at: Ok(value.created_at),
                id: Ok(value.id),
                name: Ok(value.name),
    ...
    impl ::std::convert::From<super::UpdateBatchInput> for UpdateBatchInput {
        fn from(value: super::UpdateBatchInput) -> Self {
            Self {
                actual_batch_size_l: Ok(value.actual_batch_size_l),
                actual_fg: Ok(value.actual_fg),
                actual_og: Ok(value.actual_og),
...
pub mod defaults {
    ...
    pub(super) fn equipment_profile_whirlpool_time_min() -> f64 {
        0_f64
    }
    pub(super) fn recipe_hopstand_temp_c() -> f64 {
        80_f64
    }
}
