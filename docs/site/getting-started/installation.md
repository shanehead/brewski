...
Brewski is available for Mac, Windows, and Linux. Download the latest release from the [GitHub releases page](https://github.com/shanehead/brewski/releases), then follow the instructions for your platform below.
...
If you ever want to know exactly where that database lives, or if you'd like to move it to a shared folder for cloud sync, go to **Settings → Database Location**.
